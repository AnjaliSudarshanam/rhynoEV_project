    ...
    <div className="container text-white mx-auto p-4">
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 md:pl-8">
          ...
          {/* Textual Details */}
          <h1 className="text-2xl text-[#BAB408] font-bold mb-4">Rhyno SE03 Lite</h1>
          <p className="mb-4">
          ...
          <table className="w-full text-left mb-6 border-collapse">
            <tbody>
              ...
              <tr>
                ...
                <td className="border p-2">1.8Kwh</td>
              </tr>
              <tr>
                <td className="border p-2 font-semibold">Max range (@30km/h)</td>
                <td className="border p-2">100 km</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border p-2">3 hours (12A)</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="border p-2">50 km/h</td>
              </tr>
              <tr>
                <td className="border p-2 font-semibold">Max range (@full speed)</td>
                <td className="border p-2">70 km</td>
              </tr>
              <tr>
